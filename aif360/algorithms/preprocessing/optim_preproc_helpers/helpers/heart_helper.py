...
if __name__ == '__main__':
    ...
    df = pd.read_csv('../../../data/raw/heart/processed.cleveland.data.csv', sep=',')
    # 1 dropna不用特地做
    ...
    df = work_flow(df, y_labels=Y_features, age_div_10=age_div_10, skip_feat=skip_feat,
                   norm_0_9=norm_0_9)
    helper.wrt_descrip_txt(df, 'heart', Y_feat=Y_features, D_feat=D_features,
